...
```
scenes/   7 hero illustrations — editable .svg mockup + .png + an AI prompt (.md)
```
...
for 5, `1000,620` for 6, `1000,600` for 7. Any SVG→PNG tool works; this
one just happens to need no install.
