...
quickest — it pulls a prebuilt binary, verifies its checksum, and
drops it in `~/.wild/bin/wild`.
...
First boot also materialises `~/.wild/` — your profile, the OCI cache,
