...
- receivables-chased: judge Every overdue outbound invoice has a recorded next step — a dunning raised, a payment promise noted, or an operator escalation naming it. (The routine chase is deterministic since ADR-0157: the daily aging tick writes effective_status overdue and the receivables-overdue flow raises the dunning Chief-free — this judge is the agentic BACKSTOP over that lane, catching anything it missed, not the primary mechanism.)
