...
`tribe-registry` mirrors it, and the Elder's per-tribe grounding gains a
"Domain context" section — ask either tribe's Elder *"which area of the
finanzen domain does the evaluations?"* and it answers from grounding.
